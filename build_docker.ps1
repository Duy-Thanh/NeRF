...
try {
    ...
    Write-Host "⚠ API not yet ready (this is normal during startup)" -ForegroundColor Yellow
}
...
Write-Host "  docker-compose -f docker-compose.simple.yml logs     # View logs" -ForegroundColor White
Write-Host "  docker-compose -f docker-compose.simple.yml down     # Stop system" -ForegroundColor White
Write-Host "  docker-compose -f docker-compose.simple.yml ps       # Check status" -ForegroundColor White
Write-Host ""
